<template>
    ...
    >
        ...
        <template #clearicon="{ clearCallback }">
            <TimesIcon @click="clearCallback" class="text-gray-400 absolute top-1/2 -mt-2 end-10" />
        </template>
...
const theme = ref<SelectPassThroughOptions>({
    root: `inline-flex cursor-pointer relative select-none rounded-md p-fluid:flex
        ...
        p-disabled:bg-gray-200 p-disabled:text-gray-500 p-disabled:pointer-events-none
    ...
    label: `block whitespace-nowrap overflow-hidden flex-auto w-[1%]
        ...
        text-gray-700 bg-transparent border-none outline-none
        p-placeholder:text-gray-400
        p-disabled:text-gray-500
    ...
    optionGroup: `m-0 px-3 py-2 bg-transparent text-gray-500 font-semibold`,
    optionGroupLabel: ``,
    option: `cursor-pointer font-normal whitespace-nowrap relative overflow-hidden flex items-center
        px-3 py-2 border-none text-gray-700 bg-transparent rounded-sm
        p-focus:bg-gray-100 p-focus:text-gray-800
        p-selected:bg-highlight p-focus:p-selected:bg-highlight-emphasis
        transition-colors duration-200`,
    optionLabel: ``,
    optionCheckIcon: `relative -ms-[0.375rem] me-[0.375rem] text-gray-700`,
    optionBlankIcon: ``,
